  ...
  if (state %in% data$State)
  {
    ...
    if (outcome %in% c("heart attack","heart failure","pneumonia"))
    {
      if (outcome == "heart attack")
      {
        ...
        if (is.numeric(num))
        {
          return(as.character(tempset[order(tempset[,3] ,tempset[,1]),][num,1]))
        }
        if (num == "best")
        {
      ...
      if (outcome == "heart failure")
      {
        ...
        if (is.numeric(num))
        {
          return(as.character(tempset[order(tempset[,4] ,tempset[,1]),][num,1]))
        }
        if (num == "best")
        {
      ...
      if (outcome == "pneumonia")
      {
        ...
        if (is.numeric(num))
        {
          return(as.character(tempset[order(tempset[,5] ,tempset[,1]),][num,1]))
        }
        if (num == "best")
        {
